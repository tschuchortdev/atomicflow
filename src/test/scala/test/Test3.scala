...
object Test3 {
  ...
  val flow1: Workflow[String, Unit] = Workflow(id = "99a2866c-99c5-49b7-b0f5-ad097a3e3a78", name = "read and send files") { (fileName: String) =>
    val fileBytes: Array[Byte] = Step(id = "533dddc7-d355-43b4-81d8-bd8051808ec5", version = 0, name = "read file") {
    ...
    val f = Step(id = sendFileStepId, version = 0, name = "send file") {
      Step.onlyOnce(
        "fileBytes" -> fileBytes
      )
    ...
    val string: String = Step(id = "9e94a750-59ba-4400-bbde-7cc25a333646", version = 0, name = "receive file file") {
